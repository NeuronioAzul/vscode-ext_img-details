...
export const zhCn: Translations = {
    ...
    quality: '质量',
    resizeOptions: '调整大小选项',
    resizeConfirm: '要调整此图像的大小吗？原始图像将以"-original"后缀备份。',
    resizeSuccess: '图像调整大小成功！',
    resizeError: '调整图像大小时出错',
    backupExists: '备份文件已存在。是否替换？',
    invalidDimensions: '无效的尺寸。宽度和高度必须是正数。',
    applyResize: '应用调整',
    cancel: '取消',
    apply: '应用',
};
