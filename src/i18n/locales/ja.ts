...
export const ja: Translations = {
    ...
    resizeConfirm: 'この画像をリサイズしますか？元の画像は"-original"の接尾辞付きでバックアップされます。',
    resizeSuccess: '画像のリサイズに成功しました！',
    resizeError: '画像のリサイズ中にエラーが発生しました',
    backupExists: 'バックアップファイルが既に存在します。置き換えますか？',
    invalidDimensions: '無効な寸法です。幅と高さは正の数である必要があります。',
    applyResize: 'リサイズを適用',
    cancel: 'キャンセル',
    apply: '適用',
};
